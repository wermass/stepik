...
html = urlopen('https://stepik.org/media/attachments/lesson/209723/4.html').read().decode('utf-8')  #  открыл юрл, почему то только ссылку с сайта, если качаю со степика, открыть не получается file:///C:/msys64/home/User/stepik/scraping/3.html
